...
for (let item of simpsons) {
    ...
    h2.innerHTML = `${item['name']} ${item['surname']}`;
    div.appendChild(h2);

    let h3 = document.createElement('h3');
    h3.textContent = `Age: ${item['age']} years`;
    div.appendChild(h3);
...
for (let item of coursesArray) {
    ...
    titleDiv.classList.add('courses__title');
    const titleName = document.createElement('h2');
    titleName.textContent = `${item['title']}`;
    titleDiv.appendChild(titleName);
    coursesContainer.appendChild(titleDiv);
    //Duration
    const durationDiv = document.createElement('div');
    durationDiv.classList.add('courses__duration');

    const monthTitle = document.createElement('h3');
    monthTitle.textContent = `Month duration: ${item['monthDuration']}`;

    const hourTitle = document.createElement('h3');
    hourTitle.innerHTML = `Hour duration: ${item['hourDuration']}`;
    durationDiv.append(monthTitle, hourTitle);
    coursesContainer.append(durationDiv);
    //Modules
    const moduleDiv = document.createElement('div');
    moduleDiv.classList.add('courses__module');
